...
from custom_components.intex_spa.aio_intex_spa.intex_spa_object_info import IntexSpaInfo
from custom_components.intex_spa.aio_intex_spa.intex_spa_object_status import IntexSpaStatus
...
def bypass_get_info_fixture():
    ...
    with patch(
        "custom_components.intex_spa.aio_intex_spa.IntexSpa.async_update_info",
        return_value=info,
    ):
        yield
...
def bypass_update_data_fixture():
    ...
    with patch(
        "custom_components.intex_spa.aio_intex_spa.IntexSpa.async_update_status",
        return_value=status,
    ):
        yield
